...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Firebase Meetup Lab'),
      ),
      body: ListView(
        children: <Widget>[
          Image.asset('assets/codelab.png'),
          SizedBox(height: 8),
          IconAndDetail(Icons.calendar_today, 'February 20'),
          IconAndDetail(Icons.location_city, 'Omaha'),
          ...
          Header('Welcome to the Jersey Firebase lab'),
          Paragraph(
            'Join us for a day full of Firebase Workshops and Prices!',
          ),
          Consumer<ApplicationState>(
